...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_QWERTY] = KEYMAP( \
     /* <------------- LEFT SIDE ------------------------------------> <------------------------- RIGHT SIDE ------------------------------------------> */
        ...
        KC_LCTL, KC_LGUI, KC_LALT, MO_FUNC,  KC_SPC,                    KC_SPC,          MO_FUNC, KC_RALT, KC_NO,            KC_LEFT, KC_DOWN, KC_RGHT),
    ...
    [_FUNC] = KEYMAP( \
        ...
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,          _______, _______, \
          RESET,   DEBUG, _______, _______, _______,                   _______,          KC_RCTL, _______, _______, _______,          _______, _______)
};
